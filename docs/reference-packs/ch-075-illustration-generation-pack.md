# Chapter 75 Illustration Generation Pack

This file collects the generation-ready prompts for every Chapter 75 image.
...
**File:** `w05-ch075-hero-ch-075-sequences-and-series.png`

```text
Create a chapter-opening hero illustration for "ch-075-sequences-and-series." The image should communicate the chapter idea at first glance: What happens when you add infinitely many terms? — sometimes a finite answer. Use the first-story-hook situation as narrative anchor: Around 450 BCE, the Greek philosopher Zeno of Elea poses a paradox that baffled mathematicians for two thousand years. Keep the chapter's core mathematical act visible through concrete objects and spatial relationships, especially the chapter's central mathematical relationship.
...
If the chapter benefits from a specific readable example, weave in one explicit case such as a sequence of figures or numbers with the next term made visible by rule. The example should feel naturally embedded in the scene rather than pasted on as a poster.
...
**File:** `w05-ch075-story-ch-075-sequences-and-series.png`

```text
Create an intimate story vignette for "ch-075-sequences-and-series" based closely on this narrative moment: Around 450 BCE, the Greek philosopher Zeno of Elea poses a paradox that baffled mathematicians for two thousand years. Focus on a single human-scale action, gesture, or close scene that makes the chapter's mathematical situation emotionally and visually clear without requiring text to explain it.
...
**File:** `w05-ch075-concept-core-concept.png`

```text
Create a hand-drawn concept diagram for "ch-075-sequences-and-series" centered on core concept and core concept. The diagram should make the mathematical relationship immediately legible using explicit labels, arrows, braces, groupings, axes, or correspondences as needed.

Use one concrete, visually verifiable example: a sequence of figures or numbers with the next term made visible by rule. If quantity matters, the count must be exact. If position, rate, proportion, or transformation matters, that structure must be visible and easy to follow.
...
**File:** `w05-ch075-concept-mathematical-relationship.png`
...
**File:** `w05-ch075-map-ch-075-sequences-and-series.png`

```text
Create a historical map for "ch-075-sequences-and-series" showing where this mathematics developed, circulated, or mattered during Ancient–1800s. Mark and label the key region or transmission centers most relevant to the chapter's history with terracotta dots.
...
**File:** `w05-ch075-closing-ch-075-sequences-and-series.png`

```text
Create a quiet closing vignette for "ch-075-sequences-and-series" that leaves the reader with a spacious visual summary of the chapter's central mathematical relationship. Use a simpler, calmer arrangement than the hero image, with one clear mathematical motif that suggests the idea extending beyond the page. A suitable anchor could be a sequence of figures or numbers with the next term made visible by rule.
