# Chapter 93 Illustration Generation Pack

This file collects the generation-ready prompts for every Chapter 93 image.
...
**File:** `w07-ch093-hero-graph-theory-and-networks.png`

```text
Create a chapter-opening hero illustration for "Graph Theory and Networks." The image should communicate the chapter idea at first glance: The bridges of Königsberg, the internet, and the mathematics of connection. Use the first-story-hook situation as narrative anchor: Picture Königsberg in 1736 — a beautiful Prussian city built on both sides of the Pregel River, with seven bridges connecting its islands. On leisure walks, citizens pose a puzzle: Can you walk across all seven bridges exactly once and return home? Keep the chapter's core mathematical act visible through concrete objects and spatial relationships, especially the chapter's central mathematical relationship.
...
If the chapter benefits from a specific readable example, weave in one explicit case such as a small network of nodes and edges with paths or bridges highlighted. The example should feel naturally embedded in the scene rather than pasted on as a poster.
...
**File:** `w07-ch093-story-graph-theory-and-networks.png`

```text
Create an intimate story vignette for "Graph Theory and Networks" based closely on this narrative moment: Picture Königsberg in 1736 — a beautiful Prussian city built on both sides of the Pregel River, with seven bridges connecting its islands. On leisure walks, citizens pose a puzzle: Can you walk across all seven bridges exactly once and return home? Focus on a single human-scale action, gesture, or close scene that makes the chapter's mathematical situation emotionally and visually clear without requiring text to explain it.
...
**File:** `w07-ch093-concept-core-concept.png`

```text
Create a hand-drawn concept diagram for "Graph Theory and Networks" centered on core concept and core concept. The diagram should make the mathematical relationship immediately legible using explicit labels, arrows, braces, groupings, axes, or correspondences as needed.

Use one concrete, visually verifiable example: a small network of nodes and edges with paths or bridges highlighted. If quantity matters, the count must be exact. If position, rate, proportion, or transformation matters, that structure must be visible and easy to follow.
...
**File:** `w07-ch093-concept-mathematical-relationship.png`
...
**File:** `w07-ch093-map-graph-theory-and-networks.png`

```text
Create a historical map for "Graph Theory and Networks" showing where this mathematics developed, circulated, or mattered during 1736 CE – present. Mark and label the key region or transmission centers most relevant to the chapter's history with terracotta dots.
...
**File:** `w07-ch093-closing-graph-theory-and-networks.png`

```text
Create a quiet closing vignette for "Graph Theory and Networks" that leaves the reader with a spacious visual summary of the chapter's central mathematical relationship. Use a simpler, calmer arrangement than the hero image, with one clear mathematical motif that suggests the idea extending beyond the page. A suitable anchor could be a small network of nodes and edges with paths or bridges highlighted.
