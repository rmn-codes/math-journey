# Chapter 64 Illustration Generation Pack

This file collects the generation-ready prompts for every Chapter 64 image.
...
**File:** `w04-ch064-hero-what-trigonometry-opened-up.png`

```text
Create a chapter-opening hero illustration for "What Trigonometry Opened Up." The image should communicate the chapter idea at first glance: From measuring triangles to describing the universe — the reach of an angle. Use the first-story-hook situation as narrative anchor: Maxwell's equations. Four lines of mathematics. Written in 1865 by James Clerk Maxwell, a Scottish physicist sitting in his study. Keep the chapter's core mathematical act visible through concrete objects and spatial relationships, especially the chapter's central mathematical relationship.
...
If the chapter benefits from a specific readable example, weave in one explicit case such as a labeled triangle with side-angle correspondences visibly matched. The example should feel naturally embedded in the scene rather than pasted on as a poster.
...
**File:** `w04-ch064-story-what-trigonometry-opened-up.png`

```text
Create an intimate story vignette for "What Trigonometry Opened Up" based closely on this narrative moment: Maxwell's equations. Four lines of mathematics. Written in 1865 by James Clerk Maxwell, a Scottish physicist sitting in his study. Focus on a single human-scale action, gesture, or close scene that makes the chapter's mathematical situation emotionally and visually clear without requiring text to explain it.
...
**File:** `w04-ch064-concept-core-concept.png`

```text
Create a hand-drawn concept diagram for "What Trigonometry Opened Up" centered on core concept and core concept. The diagram should make the mathematical relationship immediately legible using explicit labels, arrows, braces, groupings, axes, or correspondences as needed.

Use one concrete, visually verifiable example: a labeled triangle with side-angle correspondences visibly matched. If quantity matters, the count must be exact. If position, rate, proportion, or transformation matters, that structure must be visible and easy to follow.
...
**File:** `w04-ch064-concept-mathematical-relationship.png`
...
**File:** `w04-ch064-map-what-trigonometry-opened-up.png`

```text
Create a historical map for "What Trigonometry Opened Up" showing where this mathematics developed, circulated, or mattered during Ancient – present. Mark and label the key region or transmission centers most relevant to the chapter's history with terracotta dots.
...
**File:** `w04-ch064-closing-what-trigonometry-opened-up.png`

```text
Create a quiet closing vignette for "What Trigonometry Opened Up" that leaves the reader with a spacious visual summary of the chapter's central mathematical relationship. Use a simpler, calmer arrangement than the hero image, with one clear mathematical motif that suggests the idea extending beyond the page. A suitable anchor could be a labeled triangle with side-angle correspondences visibly matched.
