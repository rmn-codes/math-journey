# Chapter 62 Illustration Generation Pack

This file collects the generation-ready prompts for every Chapter 62 image.
...
**File:** `w04-ch062-hero-vectors-magnitude-and-direction.png`

```text
Create a chapter-opening hero illustration for "Vectors — Magnitude and Direction." The image should communicate the chapter idea at first glance: Quantities that have both size and direction — the language of force and motion. Use the first-story-hook situation as narrative anchor: Captain Elena pilots her plane due east at 500 km/h. It's a clear day over the Atlantic. Keep the chapter's core mathematical act visible through concrete objects and spatial relationships, especially the chapter's central mathematical relationship.
...
If the chapter benefits from a specific readable example, weave in one explicit case such as a point described by radius and angle, or a vector decomposed into components. The example should feel naturally embedded in the scene rather than pasted on as a poster.
...
**File:** `w04-ch062-story-vectors-magnitude-and-direction.png`

```text
Create an intimate story vignette for "Vectors — Magnitude and Direction" based closely on this narrative moment: Captain Elena pilots her plane due east at 500 km/h. It's a clear day over the Atlantic. Focus on a single human-scale action, gesture, or close scene that makes the chapter's mathematical situation emotionally and visually clear without requiring text to explain it.
...
**File:** `w04-ch062-concept-core-concept.png`

```text
Create a hand-drawn concept diagram for "Vectors — Magnitude and Direction" centered on core concept and core concept. The diagram should make the mathematical relationship immediately legible using explicit labels, arrows, braces, groupings, axes, or correspondences as needed.

Use one concrete, visually verifiable example: a point described by radius and angle, or a vector decomposed into components. If quantity matters, the count must be exact. If position, rate, proportion, or transformation matters, that structure must be visible and easy to follow.
...
**File:** `w04-ch062-concept-mathematical-relationship.png`
...
**File:** `w04-ch062-map-vectors-magnitude-and-direction.png`

```text
Create a historical map for "Vectors — Magnitude and Direction" showing where this mathematics developed, circulated, or mattered during 1800s, Europe. Mark and label the key region or transmission centers most relevant to the chapter's history with terracotta dots.
...
**File:** `w04-ch062-closing-vectors-magnitude-and-direction.png`

```text
Create a quiet closing vignette for "Vectors — Magnitude and Direction" that leaves the reader with a spacious visual summary of the chapter's central mathematical relationship. Use a simpler, calmer arrangement than the hero image, with one clear mathematical motif that suggests the idea extending beyond the page. A suitable anchor could be a point described by radius and angle, or a vector decomposed into components.
